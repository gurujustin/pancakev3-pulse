...
describe('miscellaneous', () => {
  it('getLiquidityMinted:0', async () => {
    const tokenA = new Token(ChainId.PULSE_TESTNET, '0x0000000000000000000000000000000000000001', 18, 'A')
    const tokenB = new Token(ChainId.PULSE_TESTNET, '0x0000000000000000000000000000000000000002', 18, 'B')
