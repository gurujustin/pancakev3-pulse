...
export type MultiChainName = 'BSC' | 'ETH' | 'PULSE_TESTNET'

export type MultiChainNameExtend = MultiChainName | 'PULSE_TESTNET'
...
export const multiChainBlocksClient = {
  ...
  PULSE_TESTNET: 'https://api.thegraph.com/subgraphs/name/lengocphuc99/PULSE_TESTNET-blocks',
}
